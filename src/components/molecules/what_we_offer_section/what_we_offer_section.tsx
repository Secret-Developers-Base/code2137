    ...
    return (
        <div className={styles.container}>
            ...
            <p>
                ...
                profesjonalnej pomocy małym, średnim i dużym firmom.
                Zminimalizujemy Twój czas i koszty, oferując pomoc ekspertów w
                dogodnym dla Ciebie terminie. Pozbędziesz się problemów
                związanych z obszarem IT i łatwiej skupisz się na tym, co
                istotne dla Twojej firmy. Fachowa opieka naszych informatyków
                zmniejszy ryzyko awarii w przyszłości.
            </p>
        </div>
    );
};
