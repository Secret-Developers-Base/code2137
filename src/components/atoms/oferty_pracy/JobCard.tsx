        ...
        <>
            <div className={styles.job__card}>
                <div className={styles.job__card_header}>
                    ...
                    <div style={{ color: 'black', alignItems: 'center', display: 'flex' }}>{params.monthlyPayment} Annually</div>
                </div>
                <br />
                <div className={styles.job__card_main_section}>
                    ...
                    <div>
                        <h6 className={styles.card_title} style={{ fontSize: '18px', color: '#17a2b8', fontWeight: '400' }}>{params.localisation}</h6>
                    </div>
                    <br />
                ...
                <div className={styles.job__card_footer}>
                    ...
                    <div style={{ display: 'flex', width: '100%', justifyContent: 'center', marginTop: '3%' }}>
                        <button className={styles.card_button} onClick={(() => {window.location.href = `/oferty-pracy/${params.slicedPath}`})}>
